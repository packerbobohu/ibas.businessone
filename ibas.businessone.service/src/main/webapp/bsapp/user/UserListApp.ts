...
export class UserListApp extends ibas.BOListApplication<IUserListView, bo.User> {
    ...
    /** 应用标识 */
    static APPLICATION_ID: string = "8470e426-fb90-4c4f-a542-ac109826b2fd";
    /** 应用名称 */
    static APPLICATION_NAME: string = "businessone_app_user_list";
    /** 业务对象编码 */
    ...
    /** 删除数据，参数：目标数据集合 */
    protected deleteData(data: bo.User): void {
        // 检查目标数据
        if (ibas.objects.isNull(data)) {
            this.messages(ibas.emMessageType.WARNING, ibas.i18n.prop("shell_please_chooose_data",
