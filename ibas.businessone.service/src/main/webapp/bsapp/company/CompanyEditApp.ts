...
/** 编辑应用-公司 */
export class CompanyEditApp extends ibas.BOEditApplication<ICompanyEditView, bo.Company> {

    /** 应用标识 */
    static APPLICATION_ID: string = "06a36480-7f62-4d24-a30e-c20f0654e8d1";
    /** 应用名称 */
    static APPLICATION_NAME: string = "businessone_app_company_edit";
    /** 业务对象编码 */
...
/** 视图-公司 */
export interface ICompanyEditView extends ibas.IBOEditView {
    /** 显示数据 */
