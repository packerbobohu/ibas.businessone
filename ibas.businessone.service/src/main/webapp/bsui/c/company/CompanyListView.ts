...
import { ICompanyListView } from "../../../bsapp/company/index";

/**
 * 列表视图-公司
 */
export class CompanyListView extends ibas.BOListView implements ICompanyListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Company;
    }
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                openui5.utils.getTableSelecteds<bo.Company>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                openui5.utils.getTableSelecteds<bo.Company>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.Company[] {
        return openui5.utils.getTableSelecteds<bo.Company>(this.table);
    }
}
