define(["require", "exports", "ibas/index", "openui5/typings/ibas.utils"], function (require, exports, ibas, ibas_utils_1) {
    ...
    class UserEditView extends ibas.BOEditView {
        darw() {
            let that = this;
            this.form = new sap.ui.layout.form.SimpleForm("", {
                content: [
                    ...
                    new sap.m.Label("", { text: ibas.i18n.prop("bo_user_company") }),
                    new sap.m.Input("", {
                        type: sap.m.InputType.Text,
                        showValueHelp: true,
                        valueHelpRequest: function () {
                            that.fireViewEvents(that.chooseCompanyEvent);
                        }
                    }).bindProperty("value", {
                        path: "/company"
                    }),
                    ...
                    new sap.m.Label("", { text: ibas.i18n.prop("bo_user_objectkey") }),
                    new sap.m.Input("", {
                        enabled: false,
                        type: sap.m.InputType.Text
                    }).bindProperty("value", {
