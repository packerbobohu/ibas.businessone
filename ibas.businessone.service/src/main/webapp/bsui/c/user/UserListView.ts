 ...
 * 列表视图-用户
 */
export class UserListView extends ibas.BOListView implements IUserListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.User;
    }
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.User>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.User>(that.table)
                            );
                        }
                    }),
                ],
