...
/** 公司 */
export class Company extends BOSimple<Company> implements ICompany {

    /** 业务对象编码 */
    static BUSINESS_OBJECT_CODE: string = BO_CODE_COMPANY;
    /** 构造函数 */
    constructor() {
        super();
    }
    ...
    /** 获取-名称 */
    get name(): string {
        return this.getProperty<string>(Company.PROPERTY_NAME_NAME);
    }
    /** 设置-名称 */
    ...
    get description(): string {
        return this.getProperty<string>(Company.PROPERTY_DESCRIPTION_NAME);
    }
    /** 设置-描述 */
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(Company.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-是否启用 */
    ...
    /** 获取-服务器 */
    get server(): string {
        return this.getProperty<string>(Company.PROPERTY_SERVER_NAME);
    }
    /** 设置-服务器 */
    ...
    /** 获取-用户 */
    get user(): string {
        return this.getProperty<string>(Company.PROPERTY_USER_NAME);
    }
    /** 设置-用户 */
    ...
    /** 获取-密码 */
    get password(): string {
        return this.getProperty<string>(Company.PROPERTY_PASSWORD_NAME);
    }
    /** 设置-密码 */
    ...
    /** 获取-地址 */
    get address(): string {
        return this.getProperty<string>(Company.PROPERTY_ADDRESS_NAME);
    }
    /** 设置-地址 */
    ...
    get objectKey(): number {
        return this.getProperty<number>(Company.PROPERTY_OBJECTKEY_NAME);
    }
    /** 设置-对象编号 */
    ...
    get objectCode(): string {
        return this.getProperty<string>(Company.PROPERTY_OBJECTCODE_NAME);
    }
    /** 设置-对象类型 */
    ...
    /** 获取-实例号 */
    get logInst(): number {
        return this.getProperty<number>(Company.PROPERTY_LOGINST_NAME);
    }
    /** 设置-实例号 */
    ...
    /** 获取-服务系列 */
    get series(): number {
        return this.getProperty<number>(Company.PROPERTY_SERIES_NAME);
    }
    /** 设置-服务系列 */
    ...
    get dataSource(): string {
        return this.getProperty<string>(Company.PROPERTY_DATASOURCE_NAME);
    }
    /** 设置-数据源 */
    ...
    /** 获取-创建日期 */
    get createDate(): Date {
        return this.getProperty<Date>(Company.PROPERTY_CREATEDATE_NAME);
    }
    /** 设置-创建日期 */
    ...
    get createTime(): number {
        return this.getProperty<number>(Company.PROPERTY_CREATETIME_NAME);
    }
    /** 设置-创建时间 */
    ...
    /** 获取-更新日期 */
    get updateDate(): Date {
        return this.getProperty<Date>(Company.PROPERTY_UPDATEDATE_NAME);
    }
    /** 设置-更新日期 */
    ...
    get updateTime(): number {
        return this.getProperty<number>(Company.PROPERTY_UPDATETIME_NAME);
    }
    /** 设置-更新时间 */
    ...
    get createUserSign(): number {
        return this.getProperty<number>(Company.PROPERTY_CREATEUSERSIGN_NAME);
    }
    /** 设置-创建用户 */
    ...
    get updateUserSign(): number {
        return this.getProperty<number>(Company.PROPERTY_UPDATEUSERSIGN_NAME);
    }
    /** 设置-更新用户 */
    ...
    get createActionId(): string {
        return this.getProperty<string>(Company.PROPERTY_CREATEACTIONID_NAME);
    }
    /** 设置-创建动作标识 */
    ...
    get updateActionId(): string {
        return this.getProperty<string>(Company.PROPERTY_UPDATEACTIONID_NAME);
    }
    /** 设置-更新动作标识 */
    ...
    get dataOwner(): number {
        return this.getProperty<number>(Company.PROPERTY_DATAOWNER_NAME);
    }
    /** 设置-数据所有者 */
    ...
    get teamMembers(): string {
        return this.getProperty<string>(Company.PROPERTY_TEAMMEMBERS_NAME);
    }
    /** 设置-团队成员 */
    ...
    get organization(): string {
        return this.getProperty<string>(Company.PROPERTY_ORGANIZATION_NAME);
    }
    /** 设置-数据所属组织 */
