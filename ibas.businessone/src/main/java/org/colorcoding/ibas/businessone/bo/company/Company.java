...
public class Company extends BusinessObject<Company> implements ICompany {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 4617364480188808645L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Company.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_B1_OCOM";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_B1_COMPANY";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Company";
